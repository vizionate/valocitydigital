/* https://mondo.com/wp-content/themes/uncode-child/js/min/jquery.slimscroll.min.js */
try{
...
/* https://mondo.com/wp-content/themes/uncode-child/mondo.min.js */
try{
document.addEventListener("DOMContentLoaded",function(e){function t(){$("body").addClass("menu-isopen"),$(".menu-wrapper").addClass("open"),$("#mobile-menu-overlay").addClass("open")}function o(){$("body").removeClass("menu-isopen"),$(".menu-wrapper").removeClass("open"),$("#mobile-menu-overlay").removeClass("open")}$(".mobile-menu-button").on("click",function(){UNCODE.menuOpened?$(window).width()<959?setTimeout(function(){t()},500):o():$(window).width()<959?setTimeout(function(){o()},1500):setTimeout(function(){t()},500),setTimeout(function(){var e=$(".overlay-sequential"),n=$("body"),i=$(".mobile-menu-button");!e.hasClass("open")&&n.hasClass("menu-isopen")&&(e.removeClass("open"),$(window).width()>=959&&(t(),o())),!e.hasClass("open")&&i.hasClass("close")&&(i.removeClass("close"),e.removeClass("open"),i.css("opacity",1)),i.hasClass("close")&&!n.hasClass("menu-isopen")&&t()},600)}),$(".mobilePopupCloseBtn").click(function(e){$("#popup2").slimScroll({destroy:!0}),$("body").removeClass("overlay-open"),$("body").css("position","static"),$("body").css("top","0px")}),$(".overlayCloseBtn").click(function(e){$(".mobile-menu-button").click()}),$("#popup2 .close").click(function(e){$("body").toggleClass("overlay-open"),$("body").css("position","static")})}),function(e){setTimeout(function(){document.body.classList.remove("loading"),n.css("left",o/2-n.width()/2),e(".menu-item .dropdown-toggle").on("click",function(){e(this).parent("li");var t=e(this).next(".drop-menu");e(this).attr("data-open");"none"==t.css("display")?(e(this).next(".drop-menu").slideDown(),e(this).attr("data-open","true")):"block"==t.css("display")&&(e(this).next(".drop-menu").slideUp(),e(this).attr("data-open","false"))}),e('div[data-name="what-we-can-do"]').click(function(){link=e(".footerCTA").find("a:first").attr("href"),window.location.href=link});var t,i,s,a=e(".grid__item a").text();console.log(a),e(".grid__item a").attr("data-letters",a),e(".cancel").click(function(t){return e("body").toggleClass("menu-isopen"),e(".customOverlay").css("visibility","hidden"),e(".customOverlay").css("opacity","0"),e(".customOverlay").css("position","absolute"),e("body").css("position","static"),e("body").toggleClass("overlay-open"),t.preventDefault(),t.stopPropagation(),!1}),e("#stickyCTA").click(function(o){window.pageYOffset,e("body").css("position","static"),e("body").toggleClass("overlay-open"),t=e(window).width(),i=e(window).height(),s=e("#popup2 .overlayWrap .leftpopup .inner").height(),i-s-50,"px",t<768?e("#popup2").slimScroll({height:i+"px",alwaysVisible:!0}):e("#popup2").slimScroll({destroy:!0})}),e(".hs-form").each(function(){var t=e(this).find(".hs-button").val();e(this).find(".actions").attr("data-content",t),e(this).find(".actions:before").css("content",t)}),e(".heroLookWrapper").each(function(){var t=e(this).find(".heroAfterHover").text();e(this).attr("data-content",t)})},2200);var t=2e3,o=e(window).width(),n=e(".popup-modal .popup-dialog .popup-content"),i=e("#header-sticky-image").find(".left-wrapper");function s(e,t){for(var o in t)t.hasOwnProperty(o)&&(e[o]=t[o]);return e}function a(e,t,o){var n=document.createElement(e);return n.className=t||"",n.innerHTML=o||"",n}function r(e,t){this.el=e,this.options=s({},this.options),s(this.options,t),this._init()}"#team-section"==window.location.hash&&"/culture/"==window.location.pathname&&(t=3e3),setTimeout(function(){},t),e(window).load(function(){var t=e(window).width(),o=e(".loader-container"),n=e(".loader-container").find(".slide-pane");e(".loader-container").find(".loader");n.animate({left:t},750,function(){o.hide()})}),e("html").on("touchmove",function(){if(i.length){i.offset().top;var t=e(window).scrollTop();console.log(t),t>=offset_val?i.addClass("is-sticky"):i.removeClass("is-sticky")}}),r.prototype.options={isContentHidden:!0,revealSettings:{direction:"lr",bgcolor:"#f0f0f0",duration:500,easing:"easeInOutQuint",coverArea:0,onCover:function(e,t){return!1},onStart:function(e,t){return!1},onComplete:function(e,t){return!1}}},r.prototype._init=function(){this._layout()},r.prototype._layout=function(){var e=getComputedStyle(this.el).position;"fixed"!==e&&"absolute"!==e&&"relative"!==e&&(this.el.style.position="relative"),this.content=a("div","block-revealer__content",this.el.innerHTML),this.options.isContentHidden&&(this.content.style.opacity=0),this.revealer=a("div","block-revealer__element"),this.el.classList.add("block-revealer"),this.el.innerHTML="",this.el.appendChild(this.content),this.el.appendChild(this.revealer)},r.prototype._getTransformSettings=function(e){var t,o,n;switch(e){case"lr":t="scale3d(0,1,1)",o="0 50%",n="100% 50%";break;case"rl":t="scale3d(0,1,1)",o="100% 50%",n="0 50%";break;case"tb":t="scale3d(1,0,1)",o="50% 0",n="50% 100%";break;case"bt":t="scale3d(1,0,1)",o="50% 100%",n="50% 0";break;default:t="scale3d(0,1,1)",o="0 50%",n="100% 50%"}return{val:t,origin:{initial:o,halfway:n}}},r.prototype.reveal=function(e){if(this.isAnimating)return!1;this.isAnimating=!0;var t=500,o="easeInOutQuint",n=0,i="#f0f0f0",s="lr",a=0,r=(e=e||this.options.revealSettings).direction||s,l=this._getTransformSettings(r);this.revealer.style.WebkitTransform=this.revealer.style.transform=l.val,this.revealer.style.WebkitTransformOrigin=this.revealer.style.transformOrigin=l.origin.initial,this.revealer.style.backgroundColor=e.bgcolor||i,this.revealer.style.opacity=1;var c=this,d={complete:function(){c.isAnimating=!1,"function"==typeof e.onComplete&&e.onComplete(c.content,c.revealer)}},p={delay:e.delay||n,complete:function(){c.revealer.style.WebkitTransformOrigin=c.revealer.style.transformOrigin=l.origin.halfway,"function"==typeof e.onCover&&e.onCover(c.content,c.revealer),anime(d)}};p.targets=d.targets=this.revealer,p.duration=d.duration=e.duration||t,p.easing=d.easing=e.easing||o;var u=e.coverArea||a;"lr"===r||"rl"===r?(p.scaleX=[0,1],d.scaleX=[1,u/100]):(p.scaleY=[0,1],d.scaleY=[1,u/100]),"function"==typeof e.onStart&&e.onStart(c.content,c.revealer),anime(p)},window.RevealFx=r}(jQuery);

}
catch(e){console.error("An error has occurred: "+e.stack);}
/* https://mondo.com/wp-content/themes/uncode/library/js/min/ai-uncode.min.js */
try{
...
/* https://mondo.com/wp-content/themes/uncode/library/js/min/init.min.js */
try{
